		...
		<div class="about">
			...
			<p>
				...
				<a
					...
					<el-icon><Position /></el-icon></a
				>。在阅读完之后，我了解到构建一个作品集网站的诸多细节，这给我带来了巨大的启发。如果你也在构思自己的网站，我十分推荐你阅读它！（篇幅很短，仅
				70 页，但是内容却很丰富）
			</p>
			<p>
			...
			<p>
				有一天，我恰巧点进了
				<a href="https://wooorm.com/" target="_blank" class="tweet"
					>Titus Wormer</a
				>
			...
			<div class="navbar">
				...
				<ul>
					<li v-for="item in webList" :key="item.id">
			...
			<p>
				...
				开发，部署在自己的腾讯云服务器上。不得不说，这些框架和ui库让我省下了许多建站的功夫。如果你也有建站的需求，这绝对是不错的技术选择！
			</p>
		</div>
	</div>
</template>
